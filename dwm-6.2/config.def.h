...
static const char *term1cmd[]  = { "urxvt", NULL };
static const char *pcmanfmcmd[]  = { "pcmanfm", NULL };
static const char *okularcmd[]  = { "okular", NULL };
static const char *firefoxdevelopereditioncmd[]  = { "firefox-developer-edition", NULL };
...
static const char *bpythoncmd[] = { "st", "-e", "bpython", NULL  };
...
static Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_o,      spawn,          {.v = okularcmd  } },
  { MODKEY|ShiftMask,             XK_m,      spawn,          {.v = mocpcmd  } },
  { MODKEY|ShiftMask,             XK_v,      spawn,          {.v = vimcmd  } },
  { MODKEY|ShiftMask,             XK_b,      spawn,          {.v = bpythoncmd  } },
  { MODKEY|ShiftMask,             XK_f,      spawn,          {.v = firefoxdevelopereditioncmd  } },
  { MODKEY|ShiftMask,             XK_g,      spawn,          {.v = googlecmd  } },
  { MODKEY|ShiftMask,             XK_k,      spawn,          {.v = qutebrowsercmd  } },
	{ MODKEY,                       XK_n,      spawn,          {.v = pcmanfmcmd } },
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY|ControlMask,           XK_Return, spawn,          {.v = term1cmd } },
